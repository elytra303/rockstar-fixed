package suck.enigma.utility.render;
...
import suck.enigma.framework.shader.impl.BlurProgram;
...
import suck.enigma.utility.render.batching.impl.RoundedRectBatching;
import suck.enigma.utility.render.batching.impl.SquircleBatching;
import suck.enigma.utility.render.obj.CustomSprite;
import suck.enigma.utility.render.penis.PenisSprite;
...
public final class DrawUtility implements IMinecraft, IWindow {
   ...
   public static void initializeShaders() {
      rectangleProgram = new GlProgram(enigma.id("rectangle/data"), VertexFormats.POSITION_COLOR);
      squircleProgram = new GlProgram(enigma.id("squircle/data"), VertexFormats.POSITION_COLOR);
      squircleTextureProgram = new GlProgram(enigma.id("squircle_texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      roundedTextureProgram = new GlProgram(enigma.id("texture/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      borderProgram = new GlProgram(enigma.id("border/data"), VertexFormats.POSITION_COLOR);
      loadingProgram = new GlProgram(enigma.id("loading/data"), VertexFormats.POSITION_COLOR);
      glassProgram = new GlProgram(enigma.id("liquidglass/data"), VertexFormats.POSITION_TEXTURE_COLOR);
      gradientRectangleProgram = new GlProgram(enigma.id("gradient_rectangle/data"), VertexFormats.POSITION_COLOR);
   ...
   public static void drawSprite(MatrixStack matrices, CustomSprite sprite, float x, float y, float width, float height, ColorRGBA color) {
      drawTexture(
         matrices,
         enigma.id(sprite.getTexture().getTexture()),
         x,
         y,
         width,
         height,
