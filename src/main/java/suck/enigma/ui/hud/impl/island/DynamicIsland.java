...
import suck.enigma.ui.hud.HudElement;
import suck.enigma.ui.hud.impl.island.impl.BlinkStatus;
import suck.enigma.ui.hud.impl.island.impl.DefaultStatus;
import suck.enigma.ui.hud.impl.island.impl.EventStatus;
import suck.enigma.ui.hud.impl.island.impl.MineStatus;
import suck.enigma.ui.hud.impl.island.impl.MusicStatus;
import suck.enigma.ui.hud.impl.island.impl.NotificationStatus;
import suck.enigma.ui.hud.impl.island.impl.PVPStatus;
import suck.enigma.ui.hud.impl.island.impl.XrayStatus;
   ...
   protected void renderComponent(UIContext context) {
      ...
      if (mc.player != null) {
         ...
         if (!mc.isInSingleplayer() && mc.player.networkHandler.getPlayerListEntry(mc.player.getUuid()) != null) {
            ...
            context.drawTexture(enigma.id("icons/airplane.png"), this.x + this.width + 8.0F, this.y + 3.5F, 8.0F, 8.0F, elmtColor);
         }
      }
