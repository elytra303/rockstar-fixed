package suck.enigma.ui.menu.dropdown.components.module;
...
public class ModuleComponent extends CustomComponent {
   ...
   public ModuleComponent(Module module, MenuPanel parent) {
      this.module = module;
      this.parent = parent;
      this.enablePenis = new PenisPlayer(enigma.id("penises/check_enable.penis"));
      this.disablePenis = new PenisPlayer(enigma.id("penises/check_disable.penis"));
