...
import suck.enigma.ui.menu.modern.components.ModernSettings;
...
import suck.enigma.utility.gui.ScrollHandler;
...
import suck.enigma.utility.render.batching.impl.FadeOutBatching;
...
public class ModernScreen extends MenuScreen implements IMinecraft, IScaledResolution {
   ...
   public ModernScreen() {
      ...
      for (MenuCategory category : MenuCategory.values()) {
         ...
         try {
            modern.setPenis(new PenisPlayer(enigma.id("penises/" + category.getName().toLowerCase() + ".penis")));
      ...
      this.searchPenis = new PenisPlayer(enigma.id("penises/search.penis"));
