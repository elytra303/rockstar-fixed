package suck.enigma.systems.localization;
...
public final class Localizator {
   ...
   public static void loadTranslations() {
      String langFile = "/assets/" + enigma.MOD_ID + "/lang/" + currentLanguage.getCode() + ".lang";
   ...
   private static void parseLine(String line, int lineNumber, String fileName) {
      ...
      if (equalIndex == -1) {
         enigma.LOGGER.warn("Warning: Invalid line format at line {} in {}: {}", new Object[]{lineNumber, fileName, line});
      } else {
         String key = line.substring(0, equalIndex).trim();
         String value = line.substring(equalIndex + 1).trim();
         if (key.isEmpty()) {
            enigma.LOGGER.warn("Warning: Empty key at line {} in {}", lineNumber, fileName);
         } else {
