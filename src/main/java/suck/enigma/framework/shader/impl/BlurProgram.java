package suck.enigma.framework.shader.impl;
...
public class BlurProgram implements IMinecraft, IWindow {
   ...
   public void initShaders() {
      kawaseDownProgram = new KawaseBlurProgram(enigma.id("kawase_down/data"));
      kawaseUpProgram = new KawaseBlurProgram(enigma.id("kawase_up/data"));
   }
