package suck.enigma.framework.msdf;
...
public final class MsdfFont {
   ...
   public static class Builder {
      ...
      public MsdfFont.Builder data(String dataFileName) {
         this.dataIdentifer = Identifier.of(enigma.MOD_ID, "fonts/msdf/" + dataFileName + ".json");
         return this;
      }

      public MsdfFont.Builder atlas(String atlasFileName) {
         this.atlasIdentifier = Identifier.of(enigma.MOD_ID, "fonts/msdf/" + atlasFileName + ".png");
         return this;
      }
